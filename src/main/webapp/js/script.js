const vinhosData = {
    "sip-happens": {
        ...
        imagem: "img/Gemini_Generated_Image_qdhdkwqdhdkwqdhd (1).png", // Caminho corrigido
    ...
    "valle-andino": {
        ...
        pais: "Argentina",
        regiao: "Mendoza (Uco)",
        imagem: "img/Gemini_Generated_Image_qxx5exqxx5exqxx5 (1).png", // Caminho corrigido
    ...
    "sapphire-sunset": {
        ...
        pais: "França",
        regiao: "Provence",
        imagem: "img/Gemini_Generated_Image_42b1mg42b1mg42b1 (1).png", // Caminho corrigido
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // 3. Carregamento Dinâmico da Página de Produto (AGORA COM .JSP!)
    if (window.location.pathname.includes('produto.jsp')) {
